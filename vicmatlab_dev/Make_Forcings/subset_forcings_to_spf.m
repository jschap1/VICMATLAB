% Subset forcings
%
% Copy over ASCII forcings for a particular basin
%
% Example:
% subset_forcings(soilfile, forcdir, 'Forcings_')
...
function [soil_lon, soil_lat] = subset_forcings(soilfile, forcdir, prefix, newforcdir)
...
[lon, lat] = get_coordinates_from_VIC_file(forcdir, prefix, 'forcings');
