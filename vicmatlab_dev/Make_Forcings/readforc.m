...
forcings.temp = flipud(temp_mat);
forcings.prec = flipud(prec_mat);
forcings.ps = flipud(ps_mat);
forcings.sw = flipud(sw_mat);
forcings.lw = flipud(lw_mat);
forcings.vp = flipud(vp_mat);
forcings.wind = flipud(wind_mat);
