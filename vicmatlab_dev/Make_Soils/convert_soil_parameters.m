...
[landmask, Rdem, lon, lat] = geotiffread2(maskname);
...
% %% Test full soil parameter file
% 
% soils_full = load('/Volumes/HD3/VICParametersCONUS/vic.soil.0625.new.cal.adj.conus.plus.crb.can_no_July_T_avg.txt');
% 
% lon_full = soils_full(:,4);
% lat_full = soils_full(:,3);
% elev = soils_full(:,22);
% elev_full = xyz2grid(lon_full, lat_full, elev);
% 
% 
% % pcolor(lon_full, lat_full, elev_full)
% 
% figure, plotraster(flip(lon_full), lat_full, elev_full, 'livneh elevation', '', '')
