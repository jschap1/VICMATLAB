...
% Specialized for v1_3 of the vegetation parameter file, which uses
% fractional land cover classes, but does not include albedo, LAI, etc.
% 
% INPUTS
...
function [nvegtable, vegparamtable, latlontable, LC] = read_vegparam(vegfile, soils, ncells, savename)
...
if strcmp(classification_scheme, 'IGBP')
...
while k<ncells
    ...
    for ii=1:current_nveg
        ...
        vegparamtable.(LC.class_names{current_vegtype})(k, 2:end) = nline(2:end); 
    end
