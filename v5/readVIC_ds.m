...
%
% Timing profile:
% Each parfor loop takes about 10 minutes with six processors, for 72000
% files
% 12.5 seconds on one processor for 235 files;
% for 72000 files, it should take about one hour
