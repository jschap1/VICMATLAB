...
control_params.global_param = '/Volumes/HD4/SWOTDA/Data/IRB/Test_Runs/EB_FS_JF1980/par_EB_FS_JF1980.txt';

% location where parallelized inputs for the VIC model should be saved
control_params.out_dir = '/Volumes/HD4/SWOTDA/Data/IRB/Test_Runs/EB_FS_JF1980/parallel';
...
control_params.vic_out_dir = '/u/scratch/j/jschaper/EB_FS_JF1980';

% location on Hoffman2 from which global parameter files and soil parameter files will be read
control_params.vic_in_dir = '/u/home/j/jschaper/vic/IRB/EB_FS_JF1980/parallel';

control_params.n_proc = 40; % number of processors
...
cd '/Volumes/HD3/SWOTDA/Calibration/CalVIC'
